...
// 中国相关 URL
const (
	JSChinaCPIYearlyURL          = "https://cdn.jin10.com/dc/reports/dc_chinese_cpi_yoy_all.js?v=%s&_=%s"
	JSChinaCPIMonthlyURL         = "https://cdn.jin10.com/dc/reports/dc_chinese_cpi_mom_all.js?v=%s&_=%s"
	JSChinaM2YearlyURL           = "https://cdn.jin10.com/dc/reports/dc_chinese_m2_money_supply_yoy_all.js?v=%s&_=%s"
	JSChinaPPIYearlyURL          = "https://cdn.jin10.com/dc/reports/dc_chinese_ppi_yoy_all.js?v=%s&_=%s"
	JSChinaPMIYearlyURL          = "https://cdn.jin10.com/dc/reports/dc_chinese_manufacturing_pmi_all.js?v=%s&_=%s"
	JSChinaGDPYearlyURL          = "https://cdn.jin10.com/dc/reports/dc_chinese_gdp_yoy_all.js?v=%s&_=%s"
	JSChinaCXPMIYearlyURL        = "https://cdn.jin10.com/dc/reports/dc_chinese_caixin_manufacturing_pmi_all.js?v=%s&_=%s"
	JSChinaCXServicePMIYearlyURL = "https://cdn.jin10.com/dc/reports/dc_chinese_caixin_services_pmi_all.js?v=%s&_=%s"
	JSChinaFXReservesYearlyURL   = "https://cdn.jin10.com/dc/reports/dc_chinese_fx_reserves_all.js?v=%s&_=%s"
	JSChinaEnergyDailyURL        = "https://cdn.jin10.com/dc/reports/dc_qihuo_energy_report_all.js?v=%s&_=%s"
	JSChinaNonManPMIMonthlyURL   = "https://cdn.jin10.com/dc/reports/dc_chinese_non_manufacturing_pmi_all.js?v=%s&_=%s"
	JSChinaRMBDailyURL           = "https://cdn.jin10.com/dc/reports/dc_rmb_data_all.js?v=%s&_=%s"
	JSChinaMarketMarginSZURL     = "https://cdn.jin10.com/dc/reports/dc_market_margin_sz_all.js?v=%s&_=%s"
	JSChinaMarketMarginSHURL     = "https://cdn.jin10.com/dc/reports/dc_market_margin_sse_all.js?v=%s&_=%s"
	JSChinaReportURL             = "https://cdn.jin10.com/dc/reports/dc_sge_report_all.js?v=%s&_=%s"
)

// 美国相关 URL
const (
	JSUSAInterestRateURL     = "https://cdn.jin10.com/dc/reports/dc_usa_interest_rate_decision_all.js?v=%s&_=%s"
	JSUSANonFarmURL          = "https://cdn.jin10.com/dc/reports/dc_nonfarm_payrolls_all.js?v=%s&_=%s"
	JSUSAUnemploymentRateURL = "https://cdn.jin10.com/dc/reports/dc_usa_unemployment_rate_all.js?v=%s&_=%s"
	JSUSAEIACrudeURL         = "https://cdn.jin10.com/dc/reports/dc_eia_crude_oil_all.js?v=%s&_=%s"
	JSUSAInitialJoblessURL   = "https://cdn.jin10.com/dc/reports/dc_initial_jobless_all.js?v=%s&_=%s"
	JSUSACorePCEPriceURL     = "https://cdn.jin10.com/dc/reports/dc_usa_core_pce_price_all.js?v=%s&_=%s"
	JSUSACPIMonthlyURL       = "https://cdn.jin10.com/dc/reports/dc_usa_cpi_all.js?v=%s&_=%s"
	JSUSALMCIURL             = "https://cdn.jin10.com/dc/reports/dc_usa_lmci_all.js?v=%s&_=%s"
	JSUSAADPNonfarmURL       = "https://cdn.jin10.com/dc/reports/dc_adp_nonfarm_employment_all.js?v=%s&_=%s"
	JSUSAGDPMonthlyURL       = "https://cdn.jin10.com/dc/reports/dc_usa_gdp_all.js?v=%s&_=%s"
	JSUSAEIACrudeProduceURL  = "https://cdn.jin10.com/dc/reports/dc_eia_crude_oil_produce_all.js?v=%s&_=%s"
)

// 欧元区相关 URL
const (
	JSEuroRateDecisionURL = "https://cdn.jin10.com/dc/reports/dc_interest_rate_decision_all.js?v=%s&_=%s"
)

// 组成报告相关 URL
const (
	JSConsGoldETFURL   = "https://cdn.jin10.com/dc/reports/dc_etf_gold_all.js?v=%s&_=%s"
	JSConsSliverETFURL = "https://cdn.jin10.com/dc/reports/dc_etf_sliver_all.js?v=%s&_=%s"
	JSConsOPECURL      = "https://cdn.jin10.com/dc/reports/dc_opec_report_all.js?v=%s&_=%s"
)

// USANameURLMap 美国报告名称与URL映射
var USANameURLMap = map[string]string{
...
// ChinaNameURLMap 中国报告名称与URL映射
var ChinaNameURLMap = map[string]string{
...
// EuroNameURLMap 欧元区报告名称与URL映射
var EuroNameURLMap = map[string]string{
...
// WorldCentralBankMap 全球央行决议报告映射
var WorldCentralBankMap = map[string]string{
	"美联储决议报告":   "//datacenter.jin10.com/reportType/dc_usa_interest_rate_decision",
...
// ConstituteReportMap 组成报告映射
var ConstituteReportMap = map[string]string{
