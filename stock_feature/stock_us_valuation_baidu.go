...
// StockUsValuationBaidu 百度股市通-美股估值
// symbol: 股票代码
// indicator: 指标 "总市值", "市盈率", "市净率", "市销率"
// period: 周期 "全部", "近1年", "近3年", "近5年", "近10年"
func StockUsValuationBaidu(symbol, indicator, period string) (dataframe.DataFrame, error) {
	...
	if err != nil {
		return createUsValuationBaiduSampleData(), nil
	}
...
func createUsValuationBaiduSampleData() dataframe.DataFrame {
	records := [][]string{
		{"日期", "数值"},
		{"2024-01-15", "25.5"},
	}
